...
[![PyPI](https://img.shields.io/pypi/v/taskuary.svg?cacheSeconds=300&release=0.3.4.2&asof=2026-09-10)](https://pypi.org/project/taskuary/)
...
Taskuary is early—currently **v0.3.4.2**—so breaking changes are still possible before 1.0.
