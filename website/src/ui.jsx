...
export const CHANNEL_COLORS = { teams: "#6264A7", email: "#41525f", github: "#2b2a26", report: "#c47d1a", assistant: "#6f8a6e",
  followup: "#6f8a6e", prep: "#8a7a5c", cold: "#8a3646", ahead: "#c47d1a", idea: "#55697a",     // the assistant's producers (Settings)
...
const CHANNEL_ICONS = { teams: GroupsIcon, github: GitHubIcon, report: AssessmentIcon, assistant: SmartToyIcon,
  followup: SendIcon, prep: GroupsIcon, cold: ErrorOutlineIcon, ahead: NotificationsActiveIcon, idea: AutoAwesomeIcon,
